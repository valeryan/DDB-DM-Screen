...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/vue-loader/dist/index.js??ruleSet[1].rules[8].use[0]!./src/components/CharacterCard.vue?vue&type=style&index=0&id=359218f9&lang=scss":
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".dms-character-container .dms-card{background:#1b1b1b;padding:10px;color:#fff}.dms-character-container .dms-card .dms-header{width:100%;display:flex}.dms-character-container .dms-card .dms-header .dms-portrait{flex:0 0 auto}.dms-character-container .dms-card .dms-header .dms-portrait-image{background-position:center center;background-size:cover;border-radius:3px;height:60px;width:60px;margin-right:10px}.dms-character-container .dms-card .dms-header .dms-info{flex:1 1 100%;min-width:0;padding-right:10px}.dms-character-container .dms-card .dms-header .dms-health{text-align:center}.dms-character-container .dms-card .dms-stats{width:100%;display:flex}.dms-character-container .dms-card .dms-stats .dms-stat-block{text-align:center;max-width:25%;width:25%;margin:0 15px}.dms-character-container .dms-card .dms-stats .dms-stat-label{word-spacing:100vw}", ""]);
// Exports
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/vue-loader/dist/index.js??ruleSet[1].rules[8].use[0]!./src/components/CharacterListing.vue?vue&type=style&index=0&id=1f55f47b&lang=scss":
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".dms-character-container{display:grid;grid-gap:10px;padding:0;margin:0;list-style:none;grid-template-columns:repeat(1, 1fr)}@media screen and (min-width: 740px){.dms-character-container{grid-template-columns:repeat(2, 1fr)}}@media(min-width: 1100px){.dms-character-container{grid-template-columns:repeat(3, 1fr)}}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
const PublicInstanceProxyHandlers = {
  ...
  has({
    ...
    let normalizedProps;
    return accessCache[key] !== undefined || data !== shared_esm_bundler_EMPTY_OBJ && shared_esm_bundler_hasOwn(data, key) || setupState !== shared_esm_bundler_EMPTY_OBJ && shared_esm_bundler_hasOwn(setupState, key) || (normalizedProps = propsOptions[0]) && shared_esm_bundler_hasOwn(normalizedProps, key) || shared_esm_bundler_hasOwn(ctx, key) || shared_esm_bundler_hasOwn(publicPropertiesMap, key) || shared_esm_bundler_hasOwn(appContext.config.globalProperties, key);
  }
...
function Appvue_type_template_id_52c55aa2_ts_true_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_CharacterListing = resolveComponent("CharacterListing");

  return openBlock(), createBlock(Suspense, null, {
    default: withCtx(() => [runtime_core_esm_bundler_createVNode(_component_CharacterListing)]),
    fallback: withCtx(() => [_hoisted_1]),
    _: 1
    /* STABLE */

  });
}
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-2.use[0]!./node_modules/ts-loader/index.js??clonedRuleSet-2.use[1]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/dist/index.js??ruleSet[1].rules[8].use[0]!./src/components/CharacterListing.vue?vue&type=template&id=1f55f47b&ts=true

const CharacterListingvue_type_template_id_1f55f47b_ts_true_hoisted_1 = {
  class: "dms-character-container"
};
function CharacterListingvue_type_template_id_1f55f47b_ts_true_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_CharacterCard = resolveComponent("CharacterCard");

  return openBlock(), createElementBlock("ul", CharacterListingvue_type_template_id_1f55f47b_ts_true_hoisted_1, [(openBlock(true), createElementBlock(runtime_core_esm_bundler_Fragment, null, renderList(_ctx.characters, char => {
    return openBlock(), createBlock(_component_CharacterCard, {
...
;// CONCATENATED MODULE: ./src/components/CharacterListing.vue?vue&type=template&id=1f55f47b&ts=true
...
const axiosApiInstance = external_axios_default().create();
...
const getAuthToken = async () => {
  const result = await external_axios_default().post(authURL, {}, {
    withCredentials: true
  });
  return `Bearer ${result.data.token}`;
};
;// CONCATENATED MODULE: ./node_modules/babel-loader/lib/index.js??clonedRuleSet-2.use[0]!./node_modules/ts-loader/index.js??clonedRuleSet-2.use[1]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/dist/index.js??ruleSet[1].rules[8].use[0]!./src/components/CharacterCard.vue?vue&type=template&id=359218f9&ts=true

const CharacterCardvue_type_template_id_359218f9_ts_true_hoisted_1 = {
  class: "dms-card"
};
const _hoisted_2 = {
  class: "dms-header"
...
const _hoisted_24 = /*#__PURE__*/createBaseVNode("div", {
  class: "dms-stat-label"
}, "Armor Class", -1
/* HOISTED */
);
...
const _hoisted_25 = {
  class: "ddb-campaigns-character-card-footer"
};
const _hoisted_26 = {
  class: "ddb-campaigns-character-card-footer-links"
};
const _hoisted_27 = ["href"];
const _hoisted_28 = ["href"];
const _hoisted_29 = ["href"];
const _hoisted_30 = ["href"];
function CharacterCardvue_type_template_id_359218f9_ts_true_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("li", CharacterCardvue_type_template_id_359218f9_ts_true_hoisted_1, [createBaseVNode("div", _hoisted_2, [createBaseVNode("div", _hoisted_3, [createBaseVNode("div", {
    class: "dms-portrait-image",
    style: normalizeStyle('background-image: url(' + _ctx.character.avatarUrl + ');')
  }, null, 4
  /* STYLE */
  )]), createBaseVNode("div", _hoisted_4, [createBaseVNode("div", _hoisted_5, toDisplayString(_ctx.character.name), 1
  /* TEXT */
  ), createBaseVNode("div", _hoisted_6, " Lvl " + toDisplayString(_ctx.character.level) + " | " + toDisplayString(_ctx.character.race.name), 1
  /* TEXT */
  ), createBaseVNode("div", _hoisted_7, [(openBlock(true), createElementBlock(runtime_core_esm_bundler_Fragment, null, renderList(_ctx.character.classes, cl => {
    return openBlock(), createElementBlock(runtime_core_esm_bundler_Fragment, {
      key: cl.name
    }, [createTextVNode(toDisplayString(cl.name) + " " + toDisplayString(cl.subclassName != null ? "/ " + cl.subclassName : ""), 1
    /* TEXT */
    )], 64
    /* STABLE_FRAGMENT */
    );
  ...
  /* KEYED_FRAGMENT */
  ))]), createBaseVNode("div", _hoisted_8, "Player: " + toDisplayString(_ctx.character.userName), 1
  /* TEXT */
  )]), createBaseVNode("div", _hoisted_9, [createBaseVNode("div", _hoisted_10, toDisplayString(_ctx.character.hitPointInfo.current) + "/" + toDisplayString(_ctx.character.hitPointInfo.maximum), 1
  /* TEXT */
  ), _hoisted_11])]), createBaseVNode("div", _hoisted_12, [createBaseVNode("div", _hoisted_13, [createBaseVNode("div", _hoisted_14, toDisplayString(_ctx.character.passivePerception), 1
  /* TEXT */
  ), _hoisted_15]), createBaseVNode("div", _hoisted_16, [createBaseVNode("div", _hoisted_17, toDisplayString(_ctx.character.passiveInvestigation), 1
  /* TEXT */
  ), _hoisted_18]), createBaseVNode("div", _hoisted_19, [createBaseVNode("div", _hoisted_20, toDisplayString(_ctx.character.passiveInsight), 1
  /* TEXT */
  ), _hoisted_21]), createBaseVNode("div", _hoisted_22, [createBaseVNode("div", _hoisted_23, toDisplayString(_ctx.character.armorClass), 1
  /* TEXT */
  ), _hoisted_24])]), createBaseVNode("div", _hoisted_25, [createBaseVNode("div", _hoisted_26, [createBaseVNode("a", {
    href: '/profile/' + _ctx.character.userName + '/characters/' + _ctx.character.characterId,
    class: "ddb-campaigns-character-card-footer-links-item ddb-campaigns-character-card-footer-links-item-view"
  }, "View", 8
  /* PROPS */
  , _hoisted_27), createBaseVNode("a", {
    href: '/profile/' + _ctx.character.userName + '/characters/' + _ctx.character.characterId + '/builder',
    class: "ddb-campaigns-character-card-footer-links-item ddb-campaigns-character-card-footer-links-item-edit"
  }, "Edit", 8
  /* PROPS */
  , _hoisted_28), createBaseVNode("a", {
    class: "modal-link ddb-campaigns-character-card-footer-links-item ddb-campaigns-character-card-footer-links-item-deactivate",
    href: '/campaigns/' + _ctx.character.campaign.id + '/deactivate-character/' + _ctx.character.characterId,
  ...
  /* PROPS */
  , _hoisted_29), createBaseVNode("a", {
    class: "modal-link ddb-campaigns-character-card-footer-links-item ddb-campaigns-character-card-footer-links-item-remove",
    href: '/campaigns/' + _ctx.character.campaign.id + '/remove-character/' + _ctx.character.characterId,
...
;// CONCATENATED MODULE: ./src/components/CharacterCard.vue?vue&type=template&id=359218f9&ts=true
...
/* harmony default export */ const CharacterCardvue_type_script_lang_ts = (runtime_core_esm_bundler_defineComponent({
  name: "CharacterCard",
  props: {
    character: {
      type: Object,
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/vue-loader/dist/index.js??ruleSet[1].rules[8].use[0]!./src/components/CharacterCard.vue?vue&type=style&index=0&id=359218f9&lang=scss
var CharacterCardvue_type_style_index_0_id_359218f9_lang_scss = __webpack_require__("./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/vue-loader/dist/index.js??ruleSet[1].rules[8].use[0]!./src/components/CharacterCard.vue?vue&type=style&index=0&id=359218f9&lang=scss");
...
var update = injectStylesIntoStyleTag_default()(CharacterCardvue_type_style_index_0_id_359218f9_lang_scss/* default */.Z, options);




       /* harmony default export */ const components_CharacterCardvue_type_style_index_0_id_359218f9_lang_scss = (CharacterCardvue_type_style_index_0_id_359218f9_lang_scss/* default */.Z && CharacterCardvue_type_style_index_0_id_359218f9_lang_scss/* default.locals */.Z.locals ? CharacterCardvue_type_style_index_0_id_359218f9_lang_scss/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/components/CharacterCard.vue?vue&type=style&index=0&id=359218f9&lang=scss
...
const __exports__ = /*#__PURE__*/(0,exportHelper/* default */.Z)(CharacterCardvue_type_script_lang_ts, [['render',CharacterCardvue_type_template_id_359218f9_ts_true_render]])

/* harmony default export */ const CharacterCard = (__exports__);
...
const getActiveCharacters = async () => {
  ...
  const result = await utils_get(`${campaignBaseURL}/stt/active-short-characters/${campaignID[1]}`);
  return result.data.data;
};

const getSCDSData = async ids => {
...
/* harmony default export */ const CharacterListingvue_type_script_lang_ts = (runtime_core_esm_bundler_defineComponent({
  name: "CharacterListing",
  components: {
    CharacterCard: CharacterCard
  },
  setup: async () => {
    let characters = reactivity_esm_bundler_ref([]);
    ...
    const fetchData = async () => {
      ...
      let scdsChars = await getSCDSData(charIds);
      scdsChars = scdsChars.filter(ch => {
        return ch.isAssignedToPlayer;
      });
      characters.value = scdsChars.map(ch => {
        const ACChar = activeChars.find(el => {
          return el.id === ch.characterId;
        });
        ch.avatarUrl = ACChar.avatarUrl != "" ? ACChar.avatarUrl : "https://www.dndbeyond.com/content/1-0-1772-0/skins/waterdeep/images/characters/default-avatar.png";
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/vue-loader/dist/index.js??ruleSet[1].rules[8].use[0]!./src/components/CharacterListing.vue?vue&type=style&index=0&id=1f55f47b&lang=scss
var CharacterListingvue_type_style_index_0_id_1f55f47b_lang_scss = __webpack_require__("./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/vue-loader/dist/index.js??ruleSet[1].rules[8].use[0]!./src/components/CharacterListing.vue?vue&type=style&index=0&id=1f55f47b&lang=scss");
;// CONCATENATED MODULE: ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/vue-loader/dist/index.js??ruleSet[1].rules[8].use[0]!./src/components/CharacterListing.vue?vue&type=style&index=0&id=1f55f47b&lang=scss
...
var CharacterListingvue_type_style_index_0_id_1f55f47b_lang_scss_options = {};

CharacterListingvue_type_style_index_0_id_1f55f47b_lang_scss_options.styleTagTransform = (styleTagTransform_default());
CharacterListingvue_type_style_index_0_id_1f55f47b_lang_scss_options.setAttributes = (setAttributesWithoutAttributes_default());

      CharacterListingvue_type_style_index_0_id_1f55f47b_lang_scss_options.insert = insertBySelector_default().bind(null, "head");
    
CharacterListingvue_type_style_index_0_id_1f55f47b_lang_scss_options.domAPI = (styleDomAPI_default());
CharacterListingvue_type_style_index_0_id_1f55f47b_lang_scss_options.insertStyleElement = (insertStyleElement_default());

var CharacterListingvue_type_style_index_0_id_1f55f47b_lang_scss_update = injectStylesIntoStyleTag_default()(CharacterListingvue_type_style_index_0_id_1f55f47b_lang_scss/* default */.Z, CharacterListingvue_type_style_index_0_id_1f55f47b_lang_scss_options);




       /* harmony default export */ const components_CharacterListingvue_type_style_index_0_id_1f55f47b_lang_scss = (CharacterListingvue_type_style_index_0_id_1f55f47b_lang_scss/* default */.Z && CharacterListingvue_type_style_index_0_id_1f55f47b_lang_scss/* default.locals */.Z.locals ? CharacterListingvue_type_style_index_0_id_1f55f47b_lang_scss/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/components/CharacterListing.vue?vue&type=style&index=0&id=1f55f47b&lang=scss
...
const CharacterListing_exports_ = /*#__PURE__*/(0,exportHelper/* default */.Z)(CharacterListingvue_type_script_lang_ts, [['render',CharacterListingvue_type_template_id_1f55f47b_ts_true_render]])
...
;
const App_exports_ = /*#__PURE__*/(0,exportHelper/* default */.Z)(Appvue_type_script_lang_ts, [['render',Appvue_type_template_id_52c55aa2_ts_true_render]])
